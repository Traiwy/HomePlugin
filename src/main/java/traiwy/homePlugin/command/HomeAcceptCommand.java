...
public class HomeAcceptCommand implements CommandExecutor {
    ...
    public HomeAcceptCommand(ConfirmationManagerShareMessagePlayer confirmationManagerShareMessagePlayer) {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        //            //Location loc = homeManager.getHome(senderPlayer, homeName)if (loc != null) {
