...
public class ConfirmationManagerShareMessagePlayer {
    public static final HashMap<UUID, DoorSelection> transmissionSelection = new HashMap<>();
    ...
    public boolean hasActiveRequest(UUID playerID) {
        ...
        return transmissionSelection.containsKey(playerID) &&
               ...
               (System.currentTimeMillis() - confirmationTimes.get(playerID)) <= CONFIRMATION_TIMEOUT;
    }

    public boolean startSelection(UUID playerID, String playerName, String doorName) {
        cleanupExpired();
