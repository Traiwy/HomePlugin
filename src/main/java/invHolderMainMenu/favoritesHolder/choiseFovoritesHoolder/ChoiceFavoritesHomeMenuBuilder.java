...
public class ChoiceFavoritesHomeMenuBuilder {
    private final HomeManager homeManager;
    public ChoiceFavoritesHomeMenuBuilder(HomeManager homeManager){
        this.homeManager = homeManager;
    }
    public void getChoiseFavoritesHomeMenu(Player player){
        Inventory inv = Bukkit.createInventory(new ChoiseFavoiritesHomeMenuHolder(),57,"Выберите избранные дома");
        ...
        var redDye = new ItemStack(Material.RED_DYE);
        inv.setItem(49, redDye);
